...
const IcCopy  = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>;
const IcTrash = () => <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>;
    ...
    <div className="page">
      ...
      <div className="topbar">
        <div>
          ...
          <div className="page-sub">Học viện Nông nghiệp Việt Nam · Quản lý biểu mẫu</div>
        </div>
      ...
      <div className="form-grid">
        ...
        <div className="ai-card" onClick={onAI}>
          <div className="ai-badge-pill">Claude AI · Anthropic</div>
          <div className="ai-title">Tạo form thông minh<br />bằng trí tuệ nhân tạo</div>
          <div className="ai-desc">Upload file PDF hoặc nhập mô tả — AI phân tích và sinh câu hỏi tự động.</div>
          <div className="ai-cta">Bắt đầu →</div>
        </div>
            ...
            <div key={form.id} className="form-card" onClick={() => onPreview(form)}>
              ...
              <div className="form-card-body">
                <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10 }}>
                  <div className="form-icon" style={{ background: accent }}>
                    <IcFile />
                  </div>
                ...
                <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
                  <span className="fc-tag">{form.questions.length} câu hỏi</span>
              ...
              <div className="form-card-actions" onClick={(e) => e.stopPropagation()}>
                <button className="fa-btn" onClick={() => onPreview(form)} title="Xem trước">
                  <IcEye />
                </button>
                <span className="fa-sep" />
                <button className="fa-btn" onClick={() => onEdit(form)} title="Chỉnh sửa">
                  <IcEdit />
                </button>
                <span className="fa-sep" />
                <button className="fa-btn" onClick={() => onDup(form)} title="Nhân bản">
                  <IcCopy />
                </button>
                <span className="fa-sep" />
                <button className="fa-btn danger" onClick={() => onDelete(form.id as number)} title="Xóa">
                  <IcTrash />
                </button>
              </div>
            </div>
      ...
      {filtered.length === 0 && search && (
        <div style={{ textAlign: "center", padding: "60px 20px", color: "#9ca3af" }}>
          <div style={{ width: 40, height: 40, margin: "0 auto 12px", display: "flex", alignItems: "center", justifyContent: "center", background: "#f3f4f6", borderRadius: 10 }}>
            <IcSearch />
          </div>
          <div style={{ fontWeight: 600, marginBottom: 4, color: "#6b7280" }}>Không tìm thấy form nào</div>
