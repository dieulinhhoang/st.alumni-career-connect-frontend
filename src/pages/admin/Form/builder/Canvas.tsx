...
export function Canvas({
  ...
  const answerPreview = () => {
    ...
    switch (question.type) {
      ...
      case "date":
        return <div style={{ ...style, fontStyle: "normal", letterSpacing: ".03em", fontSize: 12 }}>dd/mm/yyyy</div>;
      case "radio":
      case "checkbox":
        return (
          <div style={{ marginTop: 4 }}>
            {(question.options ?? []).map(o => (
              <div key={o.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "3px 0" }}>
                <div style={{
                  width: 15, height: 15,
                ...
                <span style={{ fontSize: 13, color: "#6b7280", fontFamily: "'Times New Roman', serif" }}>{o.label}</span>
              </div>
            ))}
          </div>
        );
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{
            ...
            {question.required && <span style={{ color: "#dc2626", marginLeft: 3, fontFamily: "inherit" }}>*</span>}
          </div>
