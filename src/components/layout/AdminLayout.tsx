...
const AdminLayout: React.FC<{ children?: React.ReactNode; onCollapse?: any }> = ({ children, onCollapse }) => {
    ...
    return (
        <Layout style={{ minHeight: '100vh', background: '#f8fafc' }}>
            ...
            <Sider
                trigger={null} collapsible collapsed={collapsed} width={256}
                style={{
                    background: '#fff',
            ...
            >
                {/* Logo */}
                <div style={{ height: 64, display: 'flex', alignItems: 'center', padding: '0 20px', borderBottom: '1px solid #f3f4f6' }}>
                    <Avatar shape="square" size={32} src="https://dtntmuongcha.dienbien.edu.vn/uploads/news/2023_03/3.jpg" style={{ borderRadius: 8, flexShrink: 0 }} />
                    {!collapsed && (
                        <span style={{ marginLeft: 10, fontWeight: 800, fontSize: 14, color: '#111827', letterSpacing: -0.3 }}>
                            VNUA SURVEY
                        </span>
                    )}
                </div>
            ...
            <Layout style={{ marginLeft: collapsed ? 80 : 256, transition: 'all 0.2s' }}>
                <Header style={{
                    ...
                    height: 64, borderBottom: '1px solid #f3f4f6',
                    ...
                    <Dropdown trigger={['click']} menu={{
                        ...
                        <Button type="text" style={{ height: 44, borderRadius: 8 }}>
                            <Space size={8}>
                                ...
                                <span style={{ fontWeight: 600, fontSize: 13, color: '#111827' }}>Quản trị viên</span>
                ...
                <Content style={{ margin: 24, background: '#fff', borderRadius: 14, padding: 24, border: '1px solid #f3f4f6' }}>
                    {children}
                </Content>
            </Layout>
        </Layout>
